...
module RuboCop
  ...
  class Options
    ...
    EXITING_OPTIONS = %i[version verbose_version show_cops show_docs_url lsp json_schema].freeze
  ...
  module OptionsHelp
    ...
    TEXT = {
      ...
      json_schema:                      ['Output a JSON Schema for the for the current',
